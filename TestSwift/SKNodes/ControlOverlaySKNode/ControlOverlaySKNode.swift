...
class ControlOverlaySKNode: SKNode {
    ...
    init(frame: CGRect) {
        ...
        leftPad.position = CGPoint(x: CGFloat(20),
                                   y: CGFloat(40))
        addChild(leftPad)
        ...
        let center = CGPoint( x: rightPad.position.x + rightPad.size.width / 2.0,
                              y: rightPad.position.y + rightPad.size.height / 2.0 )

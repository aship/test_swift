   ...
   // init(size: CGSize, gameObject: GameObject) {
    override func didMove(to view: SKView) {
      ...
      //  super.init(size: size)
        ...
        // The virtual D-pad
        #if os( iOS )
            controlOverlay = ControlOverlaySKNode(frame: CGRect(x: CGFloat(0),
                                                                y: CGFloat(0),
                                                                width: w,
                                                                height: h))
            controlOverlay!.leftPad.delegate = gameObject
            controlOverlay!.rightPad.delegate = gameObject
            controlOverlay!.buttonA.delegate = gameObject
